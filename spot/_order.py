...
from utils.meta import AsyncDelayedNotificationMeta

class SpotOrder(metaclass=AsyncDelayedNotificationMeta):
    ...
    async def new_order_test(self, symbol: str, side: str, type: str, **kwargs):
        ...
        Keyword Args:
            ...
            newOrderRespType (str, optional): Set the response JSON. ACK, RESULT, or FULL;
                    MARKET and LIMIT order types async default to FULL, all other orders async default to ACK.
    ...
    async def cancel_and_replace(
        ...
        Keyword Args:
            ...
            cancelNewClientOrderId (str, optional): Used to uniquely identify this cancel. Automatically generated by async default
            ...
            newClientOrderId (str, optional): Used to identify the new order. Automatically generated by async default
            strategyId (int, optional)
            strategyType (int, optional): The value cannot be less than 1000000.
            stopPrice (float, optional): Used with STOP_LOSS, STOP_LOSS_LIMIT, TAKE_PROFIT, and TAKE_PROFIT_LIMIT orders.
            trailingDelta (float, optional): Used with STOP_LOSS, STOP_LOSS_LIMIT, TAKE_PROFIT, and TAKE_PROFIT_LIMIT orders.
            icebergQty (float, optional): Used with LIMIT, STOP_LOSS_LIMIT, and TAKE_PROFIT_LIMIT to create an iceberg order.
            newOrderRespType (str, optional): Set the response JSON. MARKET and LIMIT order types async default to FULL, all other orders async default to ACK.
            recvWindow (int, optional): The value cannot be greater than 60000
        """
        check_required_parameters(
            [
    ...
    async def get_orders(self, symbol: str, **kwargs):
        ...
        Keyword Args:
            ...
            limit (int, optional): async default 500; max 1000.
            recvWindow (int, optional): The value cannot be greater than 60000
        """
        check_required_parameter(symbol, "symbol")
    ...
    async def cancel_oco_order(self, symbol, **kwargs):
        ...
        Keyword Args:
            ...
            newClientOrderId (str, optional): Used to uniquely identify this cancel. Automatically generated by async default.
            recvWindow (int, optional): The value cannot be greater than 60000
        """
        check_required_parameter(symbol, "symbol")
    ...
    async def get_oco_orders(self, **kwargs):
        ...
        Keyword Args:
            ...
            startTime (int, optional)
            endTime (int, optional)
            limit (int, optional): async default Value: 500; Max Value: 1000
            recvWindow (int, optional): The value cannot be greater than 60000
        """
    ...
    async def my_trades(self, symbol: str, **kwargs):
        ...
        Args:
            symbol (str)
        Keyword Args:
            fromId (int, optional): TradeId to fetch from. async default gets most recent trades.
